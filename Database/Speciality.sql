...
Insert into speciality(Name) values ('Diabetologists & Endocrinologist ');
...
Insert into speciality(Name) values ('Nephrologist & Physician ');
...
Insert into speciality(Name) values ('Obstetrician Gynaecologist & Infertility Specialist ');
Insert into speciality(Name) values ('Oncological Surgeon');
Insert into speciality(Name) values ('Oncologists (Cancer Specialist) ');
...
Insert into speciality(Name) values ('Speech, Language Pathologist & Audiologist ');
Insert into speciality(Name) values ('Speech, Pathologist & Therapist ');
